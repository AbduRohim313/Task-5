            ...
            <table class="min-w-full divide-y divide-gray-200">
              <thead class="bg-gray-50">
                <tr>
                  ...
                  <th scope="col" class="min-w-[12rem] py-3.5 pr-3 text-left text-sm font-semibold text-gray-900 cursor-pointer hover:bg-gray-100" @click="sortBy('name')">
                  ...
                  <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 cursor-pointer hover:bg-gray-100" @click="sortBy('email')">
                    <div class="flex items-center space-x-1">
                      <span>Email</span>
                  ...
                  <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 cursor-pointer hover:bg-gray-100" @click="sortBy('lastLoginAt')">
                    <div class="flex items-center space-x-1">
                  ...
                  <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 cursor-pointer hover:bg-gray-100" @click="sortBy('registrationTime')">
                    <div class="flex items-center space-x-1">
                  ...
                  <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 cursor-pointer hover:bg-gray-100" @click="sortBy('status')">
                    <div class="flex items-center space-x-1">
                      <span>Статус</span>
              ...
              <tbody class="divide-y divide-gray-200 bg-white">
                ...
                <tr v-for="user in users" :key="user.id" 
                  ...
                  <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500" :title="formatDate(user.registrationTime)">
