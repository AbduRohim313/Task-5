...
import { u as useFormField, t as tv, _ as _sfc_main$5 } from './Button-3VgCA0Bx.mjs';
                  ...
                  _push3(ssrRenderComponent(unref(CheckboxIndicator), {
                    ...
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        return [
                          modelValue2 === "indeterminate" ? (openBlock(), createBlock(_sfc_main$5, {
                            key: 0,
                            name: __props.indeterminateIcon || unref(appConfig).ui.icons.minus,
                            class: ui.value.icon({ class: props.ui?.icon })
                          }, null, 8, ["name", "class"])) : (openBlock(), createBlock(_sfc_main$5, {
                            key: 1,
                            name: __props.icon || unref(appConfig).ui.icons.check,
                            class: ui.value.icon({ class: props.ui?.icon })
                          }, null, 8, ["name", "class"]))
...
//# sourceMappingURL=Checkbox-DpAVMccQ.mjs.map
